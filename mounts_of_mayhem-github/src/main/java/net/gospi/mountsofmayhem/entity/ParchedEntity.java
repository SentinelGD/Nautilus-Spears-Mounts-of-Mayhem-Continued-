...
import net.gospi.mountsofmayhem.procedures.ParchedPriNachalnomPrizyvieSushchnostiProcedure;
import net.gospi.mountsofmayhem.procedures.ParchedPriGibieliSushchnostiProcedure;
...
public class ParchedEntity extends Skeleton implements RangedAttackMob {
	...
	public void die(DamageSource source) {
		super.die(source);
		ParchedPriGibieliSushchnostiProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), source.getEntity());
	}

	@Override
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata) {
		SpawnGroupData retval = super.finalizeSpawn(world, difficulty, reason, livingdata);
		ParchedPriNachalnomPrizyvieSushchnostiProcedure.execute(this);
		return retval;
	}
