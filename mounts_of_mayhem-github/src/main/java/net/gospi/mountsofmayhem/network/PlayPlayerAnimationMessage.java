...
public record PlayPlayerAnimationMessage(int player, String animation, boolean override) implements CustomPacketPayload {
	...
	public static final Type<PlayPlayerAnimationMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(MountsOfMayhemMod.MODID, "play_player_animation"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		MountsOfMayhemMod.addNetworkMessage(PlayPlayerAnimationMessage.TYPE, PlayPlayerAnimationMessage.STREAM_CODEC, PlayPlayerAnimationMessage::handleData);
	}
}