...
import net.gospi.mountsofmayhem.network.LoadPlayerAnimationMessage;
...
public class MountsOfMayhemModPlayerAnimationAPI {
	...
	private static class AnimationLoader {
		...
		public static void loadAnimations(PlayerEvent.PlayerLoggedInEvent event) {
			if (MountsOfMayhemModPlayerAnimationAPI.initialized.get(event.getEntity().getUUID()) == null) {
				if (event.getEntity() instanceof ServerPlayer player) {
					MountsOfMayhemModPlayerAnimationAPI.initialized.put(player.getUUID(), true);
