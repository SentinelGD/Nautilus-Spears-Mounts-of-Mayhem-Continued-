...
public class MountsOfMayhemModEntities {
	...
	public static final DeferredHolder<EntityType<?>, EntityType<CamelHuskEntity>> CAMEL_HUSK = register("camel_husk",
			EntityType.Builder.<CamelHuskEntity>of(CamelHuskEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(16).setUpdateInterval(3)
					.sized(1.7f, 2.375f));
