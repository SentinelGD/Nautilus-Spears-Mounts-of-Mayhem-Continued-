...
import net.gospi.mountsofmayhem.client.renderer.CamelHuskRenderer;

@EventBusSubscriber(modid = MountsOfMayhemMod.MODID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
public class MountsOfMayhemModEntityRenderers {
	...
	public static void registerEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerEntityRenderer(MountsOfMayhemModEntities.CAMEL_HUSK.get(), CamelHuskRenderer::new);
	}
}