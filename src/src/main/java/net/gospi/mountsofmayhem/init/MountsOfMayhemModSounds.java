...
public class MountsOfMayhemModSounds {
	...
	public static final DeferredHolder<SoundEvent, SoundEvent> ENTITY_CAMEL_HUSK_AMBIENT = REGISTRY.register("entity.camel_husk.ambient",
			() -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("mounts_of_mayhem", "entity.camel_husk.ambient")));
	public static final DeferredHolder<SoundEvent, SoundEvent> ENTITY_CAMEL_HUSK_HURT = REGISTRY.register("entity.camel_husk.hurt",
			() -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("mounts_of_mayhem", "entity.camel_husk.hurt")));
	public static final DeferredHolder<SoundEvent, SoundEvent> ENTITY_CAMEL_HUSK_DEATH = REGISTRY.register("entity.camel_husk.death",
			() -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("mounts_of_mayhem", "entity.camel_husk.death")));
}